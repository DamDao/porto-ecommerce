                    ...
                    <div class="header-right w-lg-max pl-2">
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="#" title="Cart" class="dropdown-toggle dropdown-arrow cart-toggle"
                                ...
                                <span class="cart-count badge-circle">23</span>
                            </a>
                            ...
                            <div class="dropdown-menu mobile-cart">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    <div class="dropdown-cart-header">Shopping Cartt</div>
                                    ...
                                    <div class="dropdown-cart-products">
                                        {{-- <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo1-product.html" class="product-image">
                                                    <img src="{{ asset('client_assets') }}/assets/images/products/product-1.jpg"
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo1-product.html" class="product-image">
                                                    <img src="{{ asset('client_assets') }}/assets/images/products/product-2.jpg"
                                                        alt="product" width="80" height="80">
                                                </a>
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo1-product.html" class="product-image">
                                                    <img src="{{ asset('client_assets') }}/assets/images/products/product-3.jpg"
                                                        alt="product" width="80" height="80">
                                                </a>
                                                <a href="#" class="btn-remove"
                                                    title="Remove Product"><span>×</span></a>
                                    ...
                                    <div class="dropdown-cart-action">
                                        ...
                                        <form action="/vnpay-payment" method="POST">
                                            {{-- @method('POST') --}}
                                            @csrf
                                            <button name="redirect" type="submit" class="btn ">Ví VNPay</button>
                                        </form>
                                    </div>
                                    <!-- End .dropdown-cart-total -->
                                </div>

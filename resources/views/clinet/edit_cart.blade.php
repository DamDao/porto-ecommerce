                                ...
                                @foreach ($carts as $item)
                                    <tr class="product-row">
                                        <td>
                                            <figure class="product-image-container">
                                                <a href="product.html" class="product-image">
                                                    <img src="{{ asset('client_assets') }}/assets/images/products/product-4.jpg"
                                                        alt="product">
                                                </a>
                                        ...
                                        <td class="text-right"><span
                                                class="subtotal-price">{{ $item->product->sale_price*$item->quantity }}</span></td>
                                    </tr>
                                @endforeach
                                ...
                                <tr>
                                    <td colspan="5" class="clearfix">
                                        ...
                                        <div class="float-right">
                                            ...
                                            <a href="{{route('cart.edit',$item->id)}}" class="btn btn-shop ">
                                                edit Cart
                                            </a>
                                        </div><!-- End .float-right -->
                                    </td>

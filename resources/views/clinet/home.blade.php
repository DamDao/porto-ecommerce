                ...
                <div class="col-lg-9">
                    ...
                    'nav': false
                        ...
                        <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #2699D0;"
                                src="{{ asset('client_assets') }}/assets/images/demoes/demo1/slider/slide-1.png"
                        ...
                        <div class="home-slide home-slide2 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #dadada;"
                                src="{{ asset('client_assets') }}/assets/images/demoes/demo1/slider/slide-2.jpg"
                                width="880" height="428" alt="home-slider">
                        ...
                        <div class="home-slide home-slide3 banner banner-md-vw banner-sm-vw  d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #e5e4e2;"
                                src="{{ asset('client_assets') }}/assets/images/demoes/demo1/slider/slide-3.jpg"
                                width="880" height="428" alt="home-slider" />
                            <div class="banner-layer text-uppercase appear-animate" data-animation-name="fadeInUpShorter">
                    ...
                    'responsive': {
                        ...
                        <div class="banner banner1 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                            ...
                            <figure class="w-100">
                                <img src="{{ asset('client_assets') }}/assets/images/demoes/demo1/banners/banner-1.jpg"
                        ...
                        <div class="banner banner2 text-uppercase banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                            ...
                            <figure class="w-100">
                                <img src="{{ asset('client_assets') }}/assets/images/demoes/demo1/banners/banner-2.jpg"
                                    style="background-color: #dadada;" alt="banner">
                            </figure>
                        ...
                        <div class="banner banner3 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                            ...
                            <figure class="w-100">
                                <img src="{{ asset('client_assets') }}/assets/images/demoes/demo1/banners/banner-3.jpg"
                                    style="background-color: #dadada;" alt="banner">
                            </figure>
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="label-group">
                                        ...
                                        @if ($item->sale_price > 0)
                                            <div class="product-label label-sale">
                                                -{{ percent($item->sale_price, $item->price) }}%</div>
                                        @endif
                                    </div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a
                                            href="{{ route('detail', $item->id) }}">{{ $item->name }}</a> </h3>
                                    ...
                                    <div class="price-box">
                                        @if ($item->sale_price > 0)
                                            ...
                                            <span class="product-price">${{ number_format($item->sale_price) }}</span>
                                        @else
                    ...
                    'responsive': {
                        ...
                        <img src="{{ asset('client_assets') }}/assets/images/brands/small/brand1.png" width="140"
                            height="60" alt="brand">
                        <img src="{{ asset('client_assets') }}/assets/images/brands/small/brand2.png" width="140"
                            height="60" alt="brand">
                        <img src="{{ asset('client_assets') }}/assets/images/brands/small/brand3.png" width="140"
                            height="60" alt="brand">
                        <img src="{{ asset('client_assets') }}/assets/images/brands/small/brand4.png" width="140"
                            height="60" alt="brand">
                        <img src="{{ asset('client_assets') }}/assets/images/brands/small/brand5.png" width="140"
                            height="60" alt="brand">
                        <img src="{{ asset('client_assets') }}/assets/images/brands/small/brand6.png" width="140"
                            height="60" alt="brand">
                    </div>
                    <!-- End .brands-slider -->
                        ...
                        <nav class="side-nav">
                            <ul class="menu menu-vertical sf-arrows">
                                ...
                                <li>
                                    ...
                                    <div class="megamenu megamenu-fixed-width megamenu-1cols">
                                        <div class="row">
                                            <div class="col-lg-4">
                    ...
                    <div class="widget widget-banners px-3 pb-3 text-center">
                        <div class="owl-carousel owl-theme dots-small">
                            ...
                            <div class="banner banner4">
                                <figure>
                                    <img src="{{ asset('client_assets') }}/assets/images/demoes/demo1/banners/banner-7.jpg"
                                        alt="banner">
                                </figure>
                            ...
                            <div class="banner banner5">
                                ...
                                <figure class="m-b-3">
                                    <img src="{{ asset('client_assets') }}/assets/images/demoes/demo1/banners/banner-8.jpg"
                                        alt="banner">
                                </figure>
                        ...
                        <div class="owl-carousel owl-theme dots-left dots-small">
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('client_assets') }}/assets/images/clients/client-1.jpg"
                                            alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('client_assets') }}/assets/images/clients/client-2.jpg"
                                            alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('client_assets') }}/assets/images/clients/client-3.jpg"
                                            alt="client">
                                    </figure>
                          ...
                          'loop': false }">
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="{{ asset('client_assets') }}/assets/images/blog/home/post-1.jpg"
                                            data-zoom-image="{{ asset('client_assets') }}/assets/images/blog/home/post-1.jpg"
                            ...
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="{{ asset('client_assets') }}/assets/images/blog/home/post-2.jpg"
                                            data-zoom-image="{{ asset('client_assets') }}/assets/images/blog/home/post-2.jpg"
                                            width="280" height="209" alt="Post">
                                    </a>
                                    <div class="post-date">
                                        <span class="day">29</span>
                            ...
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="{{ asset('client_assets') }}/assets/images/blog/home/post-3.jpg"
                                            data-zoom-image="{{ asset('client_assets') }}/assets/images/blog/home/post-3.jpg"
                                            width="280" height="209" alt="Post">
                                    </a>
                                    <div class="post-date">
                                        <span class="day">29</span>
